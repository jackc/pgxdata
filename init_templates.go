...
var configTmpl = template.Must(template.New("config").Parse(`package = "{{.PkgName}}"
...
var attributeTmpl = template.Must(template.New("attribute").Parse(`// This file is automatically generated.
package {{.PkgName}}
...
var dbTmpl = template.Must(template.New("config").Parse(`// This file is automatically generated.
package {{.PkgName}}
